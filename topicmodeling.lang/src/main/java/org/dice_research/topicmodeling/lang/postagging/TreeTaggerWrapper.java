...
public class TreeTaggerWrapper extends AbstractPosTagger implements TokenHandler<String>, AutomatonCallback {
    ...
    public static final String TREE_TAGGER_HOME_PROPERTY_KEY = "org.dice_research.topicmodeling.lang.postagging.TreeTaggerWrapper.TreeTaggerHome";// /data/m.roeder/programme/TreeTagger
    public static final String MODEL_FILE_PROPERTY_KEY = "org.dice_research.topicmodeling.lang.postagging.TreeTaggerWrapper.ModelFile";// "/data/m.roeder/programme/TreeTagger/lib/german-utf8.par:utf-8";
    public static final String ABBREVIATION_FILE_PROPERTY_KEY = "org.dice_research.topicmodeling.lang.postagging.TreeTaggerWrapper.AbbreviationFile";// "/data/m.roeder/programme/TreeTagger/lib/german-abbreviations-utf8";
