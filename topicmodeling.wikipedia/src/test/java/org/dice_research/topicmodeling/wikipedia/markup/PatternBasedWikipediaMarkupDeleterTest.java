...
public class PatternBasedWikipediaMarkupDeleterTest {
    ...
    public static List<Object[]> getData() {
        return Arrays.asList(new Object[][] { { "Test{{Link FA|id}}", "\nTest", "\nTest" },
    ...
    public PatternBasedWikipediaMarkupDeleterTest(String text, String expectedOutput,
            String expectedOutputWithoutTable) {
        this.text = text;
