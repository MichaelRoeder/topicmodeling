 ...
 * <li>{@link http://www.javaworld.com/javaworld/javatips/jw-javatip98.html} (the version we use here)</li>
 * </ul>
 * 
 ...
 * <li><code>mapInPlace(n)</code> - visit the <b>children</b> of node <code>n</code> and replace each child node
 * <code>c</code> with the return value of the call to <code>visit(c)</code>.</li>
 * </ul>
 */
