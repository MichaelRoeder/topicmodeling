...
@Deprecated
public class BackupOfWikipediaMarkupDetectingMachine implements TextMachine {

    private static final Logger LOGGER = LoggerFactory
            .getLogger(BackupOfWikipediaMarkupDetectingMachine.class);
    ...
    public void analyze(String text, TextMachineObserverState observerState) {
        ...
        for (int pos = 0; pos < chars.length; ++pos) {
            ...
            case 11: { // saw "\\[\\[[^\\]]*\\]" before
                if (c == ']') {
                    ...
                    observerState.getObserver().foundPattern(5, startPos, pos - 1, observerState);
                    state = 0;
                    --pos;
                }
                break;
        ...
        case 3: {
            observerState.getObserver().foundPattern(1, startPos, chars.length - 1, observerState);
            break;
        }
        default:
