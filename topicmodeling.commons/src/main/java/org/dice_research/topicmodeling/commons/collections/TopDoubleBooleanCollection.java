 ...
 * 
 */
public class TopDoubleBooleanCollection {
     ...
     * associated with them. Which double values are interpreted as the best is
     ...
     *            container.
     * @param sortAscending
     *            If this flag is true the lowest double value will be
     *            interpreted as the best value. If it is false the highest
     *            double value is interpreted as the best value.
     */
    public TopDoubleBooleanCollection(int n, boolean sortAscending) {
        values = new double[n];
     ...
     *         False.
     */
    public boolean add(double value, boolean object) {
     ...
     */
    private int findPosition(double value, int startPosition, int endPosition) {
