 ...
 * 
 */
public class TopFloatBooleanCollection {
     ...
     * associated with them. Which float values are interpreted as the best is
     ...
     *            container.
     * @param sortAscending
     *            If this flag is true the lowest float value will be
     *            interpreted as the best value. If it is false the highest
     *            float value is interpreted as the best value.
     */
    public TopFloatBooleanCollection(int n, boolean sortAscending) {
        values = new float[n];
        objects = new boolean[n];
     ...
     *         False.
     */
    public boolean add(float value, boolean object) {
     ...
     */
    private int findPosition(float value) {
     ...
     */
    private int findPosition(float value, int startPosition, int endPosition) {
