 ...
 * 
 */
public class TopByteBooleanCollection {
     ...
     * associated with them. Which byte values are interpreted as the best is
     ...
     *            container.
     * @param sortAscending
     *            If this flag is true the lowest byte value will be
     *            interpreted as the best value. If it is false the highest
     *            byte value is interpreted as the best value.
     */
    public TopByteBooleanCollection(int n, boolean sortAscending) {
        values = new byte[n];
     ...
     *         False.
     */
    public boolean add(byte value, boolean object) {
     ...
     */
    private int findPosition(byte value, int startPosition, int endPosition) {
