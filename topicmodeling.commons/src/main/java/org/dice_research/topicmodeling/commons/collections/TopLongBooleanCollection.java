 ...
 * 
 */
public class TopLongBooleanCollection {
     ...
     * associated with them. Which long values are interpreted as the best is
     ...
     *            container.
     * @param sortAscending
     *            If this flag is true the lowest long value will be
     *            interpreted as the best value. If it is false the highest
     *            long value is interpreted as the best value.
     */
    public TopLongBooleanCollection(int n, boolean sortAscending) {
        values = new long[n];
     ...
     *         False.
     */
    public boolean add(long value, boolean object) {
     ...
     */
    private int findPosition(long value, int startPosition, int endPosition) {
