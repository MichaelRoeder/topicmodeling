 ...
 * 
 */
public class TopIntBooleanCollection {
     ...
     * associated with them. Which int values are interpreted as the best is
     ...
     *            container.
     * @param sortAscending
     *            If this flag is true the lowest int value will be
     *            interpreted as the best value. If it is false the highest
     *            int value is interpreted as the best value.
     */
    public TopIntBooleanCollection(int n, boolean sortAscending) {
        values = new int[n];
     ...
     *         False.
     */
    public boolean add(int value, boolean object) {
     ...
     */
    private int findPosition(int value, int startPosition, int endPosition) {
