 ...
 * 
 */
public class TopFloatLongCollection {
     ...
     */
    public TopFloatLongCollection(int n, boolean sortAscending) {
        values = new float[n];
        objects = new long[n];
     ...
     *         False.
     */
    public boolean add(float value, long object) {
