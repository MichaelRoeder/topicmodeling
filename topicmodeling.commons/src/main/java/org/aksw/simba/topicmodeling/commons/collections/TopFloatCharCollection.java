 ...
 * 
 */
public class TopFloatCharCollection {
     ...
     */
    public TopFloatCharCollection(int n, boolean sortAscending) {
        values = new float[n];
        objects = new char[n];
     ...
     *         False.
     */
    public boolean add(float value, char object) {
