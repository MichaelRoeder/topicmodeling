 ...
 * 
 */
public class TopFloatByteCollection {
     ...
     */
    public TopFloatByteCollection(int n, boolean sortAscending) {
        values = new float[n];
        objects = new byte[n];
     ...
     *         False.
     */
    public boolean add(float value, byte object) {
