 ...
 * 
 */
public class TopCharBooleanCollection {
     ...
     * associated with them. Which char values are interpreted as the best is
     ...
     *            container.
     * @param sortAscending
     *            If this flag is true the lowest char value will be
     *            interpreted as the best value. If it is false the highest
     *            char value is interpreted as the best value.
     */
    public TopCharBooleanCollection(int n, boolean sortAscending) {
        values = new char[n];
     ...
     *         False.
     */
    public boolean add(char value, boolean object) {
     ...
     */
    private int findPosition(char value) {
     ...
     */
    private int findPosition(char value, int startPosition, int endPosition) {
