 ...
 * 
 */
public class TopFloatDoubleCollection {
     ...
     */
    public TopFloatDoubleCollection(int n, boolean sortAscending) {
        values = new float[n];
        objects = new double[n];
     ...
     *         False.
     */
    public boolean add(float value, double object) {
