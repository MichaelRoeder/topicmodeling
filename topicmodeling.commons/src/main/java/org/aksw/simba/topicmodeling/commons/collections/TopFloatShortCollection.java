 ...
 * 
 */
public class TopFloatShortCollection {
     ...
     */
    public TopFloatShortCollection(int n, boolean sortAscending) {
        values = new float[n];
        objects = new short[n];
     ...
     *         False.
     */
    public boolean add(float value, short object) {
