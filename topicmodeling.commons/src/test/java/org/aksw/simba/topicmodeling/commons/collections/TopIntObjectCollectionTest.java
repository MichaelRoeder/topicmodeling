...
public class TopIntObjectCollectionTest {

    private static final int DATA_SIZE = 4096;
    private static final int TOP_X = 100;

    @Test
    public void testTopIntObjectCollectionDescending() {
        ...
        TopIntObjectCollection<Integer> topCollection = new TopIntObjectCollection<Integer>(TOP_X, false);
    ...
    @Test
    public void testTopIntObjectCollectionAscending() {
        Random rand = new Random(System.currentTimeMillis());
        int values[] = new int[DATA_SIZE];
        Integer objects[] = new Integer[DATA_SIZE];
        for (int i = 0; i < DATA_SIZE; ++i) {
        ...
        TopIntObjectCollection<Integer> topCollection = new TopIntObjectCollection<Integer>(TOP_X, true);
        for (int i = 0; i < values.length; i++) {
            topCollection.add(values[i], objects[i]);
        }
