...
public class TopDoubleShortCollectionTest {

    private static final int DATA_SIZE = 4096;
    private static final int TOP_X = 100;

    @Test
    public void testTopDoubleShortCollectionDescending() {
        ...
        TopDoubleShortCollection topCollection = new TopDoubleShortCollection(TOP_X, false);
    ...
    @Test
    public void testTopDoubleShortCollectionAscending() {
        Random rand = new Random(System.currentTimeMillis());
        double values[] = new double[DATA_SIZE];
        short objects[] = new short[DATA_SIZE];
        for (int i = 0; i < DATA_SIZE; ++i) {
        ...
        TopDoubleShortCollection topCollection = new TopDoubleShortCollection(TOP_X, true);
        for (int i = 0; i < values.length; i++) {
            topCollection.add(values[i], objects[i]);
        }
