...
public class TopShortBooleanCollectionTest {

    private static final int DATA_SIZE = 4096;
    private static final int TOP_X = 100;

    @Test
    public void testTopShortBooleanCollectionDescending() {
        ...
        TopShortBooleanCollection topCollection = new TopShortBooleanCollection(TOP_X, false);
    ...
    @Test
    public void testTopShortBooleanCollectionAscending() {
        Random rand = new Random(System.currentTimeMillis());
        short values[] = new short[DATA_SIZE];
        boolean objects[] = new boolean[DATA_SIZE];
        for (int i = 0; i < DATA_SIZE; ++i) {
        ...
        TopShortBooleanCollection topCollection = new TopShortBooleanCollection(TOP_X, true);
        for (int i = 0; i < values.length; i++) {
            topCollection.add(values[i], objects[i]);
        }
