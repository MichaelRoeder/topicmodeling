...
public class TopDoubleFloatCollectionTest {

    private static final int DATA_SIZE = 4096;
    private static final int TOP_X = 100;

    @Test
    public void testTopDoubleFloatCollectionDescending() {
        ...
        TopDoubleFloatCollection topCollection = new TopDoubleFloatCollection(TOP_X, false);
    ...
    @Test
    public void testTopDoubleFloatCollectionAscending() {
        Random rand = new Random(System.currentTimeMillis());
        double values[] = new double[DATA_SIZE];
        float objects[] = new float[DATA_SIZE];
        for (int i = 0; i < DATA_SIZE; ++i) {
        ...
        TopDoubleFloatCollection topCollection = new TopDoubleFloatCollection(TOP_X, true);
        for (int i = 0; i < values.length; i++) {
            topCollection.add(values[i], objects[i]);
        }
