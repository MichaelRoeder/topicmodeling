...
public class TopCharBooleanCollectionTest {

    private static final int DATA_SIZE = 4096;
    private static final int TOP_X = 100;

    @Test
    public void testTopCharBooleanCollectionDescending() {
        ...
        TopCharBooleanCollection topCollection = new TopCharBooleanCollection(TOP_X, false);
    ...
    @Test
    public void testTopCharBooleanCollectionAscending() {
        Random rand = new Random(System.currentTimeMillis());
        char values[] = new char[DATA_SIZE];
        boolean objects[] = new boolean[DATA_SIZE];
        for (int i = 0; i < DATA_SIZE; ++i) {
        ...
        TopCharBooleanCollection topCollection = new TopCharBooleanCollection(TOP_X, true);
        for (int i = 0; i < values.length; i++) {
            topCollection.add(values[i], objects[i]);
        }
