...
public class TopIntBooleanCollectionTest {

    private static final int DATA_SIZE = 4096;
    private static final int TOP_X = 100;

    @Test
    public void testTopIntBooleanCollectionDescending() {
        ...
        TopIntBooleanCollection topCollection = new TopIntBooleanCollection(TOP_X, false);
    ...
    @Test
    public void testTopIntBooleanCollectionAscending() {
        Random rand = new Random(System.currentTimeMillis());
        int values[] = new int[DATA_SIZE];
        boolean objects[] = new boolean[DATA_SIZE];
        for (int i = 0; i < DATA_SIZE; ++i) {
        ...
        TopIntBooleanCollection topCollection = new TopIntBooleanCollection(TOP_X, true);
        for (int i = 0; i < values.length; i++) {
            topCollection.add(values[i], objects[i]);
        }
