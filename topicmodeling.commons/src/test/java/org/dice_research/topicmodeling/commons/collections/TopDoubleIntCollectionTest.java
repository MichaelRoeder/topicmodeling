...
public class TopDoubleIntCollectionTest {

    private static final int DATA_SIZE = 4096;
    private static final int TOP_X = 100;

    @Test
    public void testTopDoubleIntCollectionDescending() {
        ...
        TopDoubleIntCollection topCollection = new TopDoubleIntCollection(TOP_X, false);
    ...
    @Test
    public void testTopDoubleIntCollectionAscending() {
        Random rand = new Random(System.currentTimeMillis());
        double values[] = new double[DATA_SIZE];
        int objects[] = new int[DATA_SIZE];
        for (int i = 0; i < DATA_SIZE; ++i) {
        ...
        TopDoubleIntCollection topCollection = new TopDoubleIntCollection(TOP_X, true);
        for (int i = 0; i < values.length; i++) {
            topCollection.add(values[i], objects[i]);
        }
