...
public class TopDoubleLongCollectionTest {

    private static final int DATA_SIZE = 4096;
    private static final int TOP_X = 100;

    @Test
    public void testTopDoubleLongCollectionDescending() {
        ...
        TopDoubleLongCollection topCollection = new TopDoubleLongCollection(TOP_X, false);
    ...
    @Test
    public void testTopDoubleLongCollectionAscending() {
        Random rand = new Random(System.currentTimeMillis());
        double values[] = new double[DATA_SIZE];
        long objects[] = new long[DATA_SIZE];
        for (int i = 0; i < DATA_SIZE; ++i) {
        ...
        TopDoubleLongCollection topCollection = new TopDoubleLongCollection(TOP_X, true);
        for (int i = 0; i < values.length; i++) {
            topCollection.add(values[i], objects[i]);
        }
