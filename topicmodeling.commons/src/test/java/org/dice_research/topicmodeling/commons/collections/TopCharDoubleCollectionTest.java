...
public class TopCharDoubleCollectionTest {

    private static final int DATA_SIZE = 4096;
    private static final int TOP_X = 100;

    @Test
    public void testTopCharDoubleCollectionDescending() {
        ...
        TopCharDoubleCollection topCollection = new TopCharDoubleCollection(TOP_X, false);
    ...
    @Test
    public void testTopCharDoubleCollectionAscending() {
        Random rand = new Random(System.currentTimeMillis());
        char values[] = new char[DATA_SIZE];
        double objects[] = new double[DATA_SIZE];
        for (int i = 0; i < DATA_SIZE; ++i) {
        ...
        TopCharDoubleCollection topCollection = new TopCharDoubleCollection(TOP_X, true);
        for (int i = 0; i < values.length; i++) {
            topCollection.add(values[i], objects[i]);
        }
