...
public class TopDoubleCharCollectionTest {

    private static final int DATA_SIZE = 4096;
    private static final int TOP_X = 100;

    @Test
    public void testTopDoubleCharCollectionDescending() {
        ...
        TopDoubleCharCollection topCollection = new TopDoubleCharCollection(TOP_X, false);
    ...
    @Test
    public void testTopDoubleCharCollectionAscending() {
        Random rand = new Random(System.currentTimeMillis());
        double values[] = new double[DATA_SIZE];
        char objects[] = new char[DATA_SIZE];
        for (int i = 0; i < DATA_SIZE; ++i) {
        ...
        TopDoubleCharCollection topCollection = new TopDoubleCharCollection(TOP_X, true);
        for (int i = 0; i < values.length; i++) {
            topCollection.add(values[i], objects[i]);
        }
