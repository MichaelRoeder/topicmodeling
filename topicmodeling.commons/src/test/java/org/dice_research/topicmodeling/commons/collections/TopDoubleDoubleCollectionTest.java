...
public class TopDoubleDoubleCollectionTest {

    private static final int DATA_SIZE = 4096;
    private static final int TOP_X = 100;

    @Test
    public void testTopDoubleDoubleCollectionDescending() {
        ...
        TopDoubleDoubleCollection topCollection = new TopDoubleDoubleCollection(TOP_X, false);
    ...
    @Test
    public void testTopDoubleDoubleCollectionAscending() {
        Random rand = new Random(System.currentTimeMillis());
        double values[] = new double[DATA_SIZE];
        double objects[] = new double[DATA_SIZE];
        for (int i = 0; i < DATA_SIZE; ++i) {
        ...
        TopDoubleDoubleCollection topCollection = new TopDoubleDoubleCollection(TOP_X, true);
        for (int i = 0; i < values.length; i++) {
            topCollection.add(values[i], objects[i]);
        }
