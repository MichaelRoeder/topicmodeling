...
public class TopLongObjectCollectionTest {

    private static final int DATA_SIZE = 4096;
    private static final int TOP_X = 100;

    @Test
    public void testTopLongObjectCollectionDescending() {
        ...
        TopLongObjectCollection<Integer> topCollection = new TopLongObjectCollection<Integer>(TOP_X, false);
    ...
    @Test
    public void testTopLongObjectCollectionAscending() {
        Random rand = new Random(System.currentTimeMillis());
        long values[] = new long[DATA_SIZE];
        Integer objects[] = new Integer[DATA_SIZE];
        for (int i = 0; i < DATA_SIZE; ++i) {
        ...
        TopLongObjectCollection<Integer> topCollection = new TopLongObjectCollection<Integer>(TOP_X, true);
        for (int i = 0; i < values.length; i++) {
            topCollection.add(values[i], objects[i]);
        }
