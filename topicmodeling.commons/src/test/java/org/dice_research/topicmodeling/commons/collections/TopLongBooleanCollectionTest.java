...
public class TopLongBooleanCollectionTest {

    private static final int DATA_SIZE = 4096;
    private static final int TOP_X = 100;

    @Test
    public void testTopLongBooleanCollectionDescending() {
        ...
        TopLongBooleanCollection topCollection = new TopLongBooleanCollection(TOP_X, false);
    ...
    @Test
    public void testTopLongBooleanCollectionAscending() {
        Random rand = new Random(System.currentTimeMillis());
        long values[] = new long[DATA_SIZE];
        boolean objects[] = new boolean[DATA_SIZE];
        for (int i = 0; i < DATA_SIZE; ++i) {
        ...
        TopLongBooleanCollection topCollection = new TopLongBooleanCollection(TOP_X, true);
        for (int i = 0; i < values.length; i++) {
            topCollection.add(values[i], objects[i]);
        }
