...
public class TopDoubleObjectCollectionTest {

    private static final int DATA_SIZE = 4096;
    private static final int TOP_X = 100;

    @Test
    public void testTopDoubleObjectCollectionDescending() {
        ...
        TopDoubleObjectCollection<Integer> topCollection = new TopDoubleObjectCollection<Integer>(TOP_X, false);
    ...
    @Test
    public void testTopDoubleObjectCollectionAscending() {
        Random rand = new Random(System.currentTimeMillis());
        double values[] = new double[DATA_SIZE];
        Integer objects[] = new Integer[DATA_SIZE];
        for (int i = 0; i < DATA_SIZE; ++i) {
        ...
        TopDoubleObjectCollection<Integer> topCollection = new TopDoubleObjectCollection<Integer>(TOP_X, true);
        for (int i = 0; i < values.length; i++) {
            topCollection.add(values[i], objects[i]);
        }
