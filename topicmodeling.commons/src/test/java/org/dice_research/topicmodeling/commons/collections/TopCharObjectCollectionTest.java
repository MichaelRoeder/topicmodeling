...
public class TopCharObjectCollectionTest {

    private static final int DATA_SIZE = 4096;
    private static final int TOP_X = 100;

    @Test
    public void testTopCharObjectCollectionDescending() {
        ...
        TopCharObjectCollection<Integer> topCollection = new TopCharObjectCollection<Integer>(TOP_X, false);
    ...
    @Test
    public void testTopCharObjectCollectionAscending() {
        Random rand = new Random(System.currentTimeMillis());
        char values[] = new char[DATA_SIZE];
        Integer objects[] = new Integer[DATA_SIZE];
        for (int i = 0; i < DATA_SIZE; ++i) {
        ...
        TopCharObjectCollection<Integer> topCollection = new TopCharObjectCollection<Integer>(TOP_X, true);
        for (int i = 0; i < values.length; i++) {
            topCollection.add(values[i], objects[i]);
        }
