...
import org.dice_research.topicmodeling.lang.postagging.TreeTaggerWrapper;
...
public class NerPropagatingSupplierDecoratorTest extends AbstractDocumentSupplierDecoratorTest {
    ...
    public static Collection<Object[]> data() {
        ...
        startConfigs.add(new Object[] {
                new DocumentProperty[] { new DocumentText("Der neue Jaguar RX ist kein Golf VI."),
                        new NamedEntitiesInText(new NamedEntityInText(28, 7, "Golf_Car/IV"),
                                new NamedEntityInText(9, 9, "Jaguar_Car/RX")) },
                new int[][] { { 2, 2 }, { 0, 2 } }, new SimpleNerPropagationPreprocessor(), Language.GER });
        startConfigs.add(new Object[] {
                new DocumentProperty[] { new DocumentText("Ein Golf VI steht am Golf von Mexiko vor einem Golf Club"),
                        new NamedEntitiesInText(new NamedEntityInText(47, 4, "Golf_Sport"),
                                new NamedEntityInText(21, 16, "Golf_Geo/Mexiko"),
                                new NamedEntityInText(4, 7, "Golf_Car/IV")) },
                new int[][] { { 4, 1 }, { 2, 2 }, { 0, 2 } }, new SimpleNerPropagationPreprocessor(), Language.GER });
        startConfigs.add(new Object[] { new DocumentProperty[] { new DocumentText(
                ...
                new NamedEntitiesInText(
                        new SignedNamedEntityInText(2959, 11, "http://dbpedia.org/resource/West_Germany",
                                "http://ns.aksw.org/scms/tools/FOX"),
                        new SignedNamedEntityInText(2090, 25, "http://scms.eu/Bayerische_Vereinsbank_AG",
                                "http://ns.aksw.org/scms/tools/FOX"),
                        new SignedNamedEntityInText(1407, 11, "http://dbpedia.org/resource/West_Germany",
                                "http://ns.aksw.org/scms/tools/FOX"),
                        new SignedNamedEntityInText(0, 11, "http://dbpedia.org/resource/West_Germany",
                                "http://ns.aksw.org/scms/tools/FOX")) },
